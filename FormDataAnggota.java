...
public class FormDataAnggota extends javax.swing.JFrame {
    ...
    public FormDataAnggota() {
      ...
      private void id_data(){
        ...
        ResultSet rs = stat.executeQuery("select * from data_anggota order by id desc");
        if(rs.next()){
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, -1, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Universitas");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 310, -1, -1));
        ...
        jPanel4.add(txt_universitas, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 310, 260, -1));
        ...
        txt_status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- SELECT --", "Aktif", "Tidak Aktif" }));
        jPanel4.add(txt_status, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 190, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Angkatan");
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, -1, -1));
        ...
        jPanel4.add(txt_angkatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 260, -1));
        ...
        lb1MovingText.setText("                                                                                                                                 Form Data Anggota");
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        try{
            String sql = "INSERT INTO data_anggota VALUES ('"+txt_id.getText()+"','"+txt_nama.getText()+"','"+txt_status.getSelectedItem()+"','"+txt_angkatan.getText()+"','"+txt_universitas.getText()+"')";
    ...
    private void bhalamanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhalamanActionPerformed
        // TODO add your handling code here:
        DataAnggota backpage = new DataAnggota();
        backpage.show();
        dispose();
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try{
            String sql = "update data_anggota set nama='"+txt_nama.getText()+"', status='"+txt_status.getSelectedItem()+"', angkatan='"+txt_angkatan.getText()+"', universitas='"+txt_universitas.getText()+"' where id='"+txt_id.getText()+"'";
            java.sql.Connection con = (Connection)Konfig.configDB();
            java.sql.PreparedStatement pst = con.prepareStatement(sql);
            pst.execute();
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "DELETE FROM data_anggota WHERE id ='"+txt_id.getText()+"'";
