 ...
 * @author Me
 */
public class FormDataAlumni extends javax.swing.JFrame {
    ...
    public FormDataAlumni() {
      ...
      private void id_data(){
        ...
        ResultSet rs = stat.executeQuery("select * from data_alumni order by id desc");
        if(rs.next()){
    ...
    private void initComponents() {
        ...
        jPanel4.add(txt_no_telepon, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 260, -1));
        ...
        jPanel4.add(txt_angkatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 260, -1));
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        try{
            String sql = "INSERT INTO data_alumni VALUES ('"+txt_id.getText()+"','"+txt_nama.getText()+"','"+txt_angkatan.getText()+"','"+txt_no_telepon.getText()+"')";
    ...
    private void bhalamanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhalamanActionPerformed
        // TODO add your handling code here:
        DataAlumni backpage = new DataAlumni();
        backpage.show();
        dispose();
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try{
            String sql = "update data_alumni set nama='"+txt_nama.getText()+"', angkatan='"+txt_angkatan.getText()+"', no_telepon='"+txt_no_telepon.getText()+"'  where id='"+txt_id.getText()+"'";
            java.sql.Connection con = (Connection)Konfig.configDB();
            java.sql.PreparedStatement pst = con.prepareStatement(sql);
            pst.execute();
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "DELETE FROM data_alumni WHERE id ='"+txt_id.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDataAlumni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDataAlumni().setVisible(true);
            }
        });
    }
