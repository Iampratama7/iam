 ...
 * @author Me
 */
public class DataProgramKerja extends javax.swing.JInternalFrame {

    /**
     * Creates new form DataPesertaPKH
     */
    public DataProgramKerja() {
        initComponents();
        tampilkan_data();
    ...
    public void tampilkan_data(){
     DefaultTableModel model = new DefaultTableModel();
       ...
       model.addColumn("Program Kerja");
       try{
           int no = 1;
           String sql = "Select * From data_program_kerja";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Program Kerja");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        FormDataProgramKerja backpage = new FormDataProgramKerja();
        backpage.show();
    ...
    private void print1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_print1ActionPerformed
        // TODO add your handling code here:
        try {
            File namafile = new File("src/report/report_data_program_kerja.jasper");
