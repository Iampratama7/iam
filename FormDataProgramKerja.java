 ...
 * @author Me
 */
public class FormDataProgramKerja extends javax.swing.JFrame {
    ...
    public FormDataProgramKerja() {
      ...
      private void id_data(){
        ...
        ResultSet rs = stat.executeQuery("select * from data_program_kerja order by id desc");
        if(rs.next()){
    ...
    private void initComponents() {
        ...
        txt_program_kerja = new javax.swing.JTextField();
        ...
        jLabel5.setText("Program Kerja");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, -1, -1));
        jPanel4.add(txt_program_kerja, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 260, -1));
        ...
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, -1, -1));
        ...
        jPanel4.add(txt_departemen, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 260, -1));
        ...
        lb1MovingText.setText("                                                                                                                                      Form Data Alumni ");
    ...
    private void bsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsaveActionPerformed
        ...
        try{
            String sql = "INSERT INTO data_program_kerja VALUES ('"+txt_id.getText()+"','"+txt_nama.getText()+"','"+txt_departemen.getSelectedItem()+"','"+txt_program_kerja.getText()+"')";
    ...
    private void bhalamanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhalamanActionPerformed
        // TODO add your handling code here:
        DataProgramKerja backpage = new DataProgramKerja();
        backpage.show();
        dispose();
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        ...
        try{
            String sql = "update data_program_kerja set nama='"+txt_nama.getText()+"', departemen='"+txt_departemen.getSelectedItem()+"', program_kerja='"+txt_program_kerja.getText()+"'  where id='"+txt_id.getText()+"'";
            java.sql.Connection con = (Connection)Konfig.configDB();
            java.sql.PreparedStatement pst = con.prepareStatement(sql);
            pst.execute();
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "DELETE FROM data_program_kerja WHERE id ='"+txt_id.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormDataProgramKerja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormDataProgramKerja().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txt_program_kerja;
